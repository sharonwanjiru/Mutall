...
<html lang="en">
     ...
     <div class="day <?php if(date('l') == 'Monday') echo 'highlight'; ?>" id="Monday">
         <h2>Monday</h2>
          ...
          <div class="details">   
            ...
            <div class="portfolio">
                <a href="http://206.189.207.206/tracker/portfolio/2023/kangara.html">George Kanga'ra(GK)</a>
            </div>        
          </div>
            <!-- Andrew Details -->
          <div class="details">
    ...
    <div class="day <?php if(date('l') == 'ednesday') echo 'highlight'; ?>" id="wednesday">
        ...
        <div class="details">
                <div class="img">
                    <img class="rounded-corners" src="https://drive.google.com/uc?export=view&amp;id=1yWHhNu4NVyPjqmbXOuDDjZL9cPcF2ulH" alt="" 
                        >
                </div>
                <div class="porfolio">
    ...
    <div class="day <?php if(date('l') == 'Monday') echo 'highlight'; ?>">
        ...
        <div class="details">
            ...
            <div class="portfolio">
                <a href="http://206.189.207.206/tracker/portfolio/2023/kiberenge.html">James Kiberenge(JK)<br></a> 
          </div>   
        </div>   
    </div>
      <!-- Friday -->
    <div class="day">
       ...
       <!-- Peter's details -->
        ...
        <div class="details">
                <div class="img">
                    <img class="rounded-corners" src="muli.jpg" alt="" 
                    >
            </div>
            <div class="portfolio">
        ...
        <div class="details">
             ...
             <div class="porfolio">
            <a href="http://206.189.207.206/tracker/portfolio/2023/kaniu.html">Daniel Kaniu(DN)<br></a> 
          </div>   
        </div>   
